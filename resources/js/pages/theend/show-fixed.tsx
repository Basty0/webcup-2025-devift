...
import { Angry, ArrowRight, Award, Bookmark, Eye, Flame, Frown, Heart, MessageCircle, Share2, SmilePlus, ThumbsUp, Zap } from 'lucide-react';
                        ...
                        <CardHeader>
                            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                                <div className="flex items-start gap-4">
                                    <Link href={route('profil.ViewProfil')} className="group flex flex-col items-center">
                ...
                <motion.div className="mb-8 space-y-6" variants={animation.item}>
                    <Card className={style.cardClass}>
                        <CardContent className="pt-6">
                            ...
                            {/* Médias */}
                            {/* ... (media content is omitted for brevity) ... */}
