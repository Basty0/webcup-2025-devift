                        ...
                        <CardContent className="pt-6">
                            ...
                            {(theend.image_url || theend.sound_url) && (
                                <div className="mt-6 space-y-4">
                                    {theend.image_url && (
                                        <img src={theend.image_url} alt="Image" className="max-h-[500px] w-full rounded-lg object-cover shadow-md" />
                                    )}
                                    {theend.sound_url && (
                                        <div
                                            className={`overflow-hidden rounded-lg border border-white/20 bg-black/25 p-4 shadow-md backdrop-blur-sm ${style.cardClass}`}
                                        >
                                            <div className="flex items-center space-x-4">
                                                <Button
                                                    onClick={togglePlay}
                                                    className={`h-10 w-10 rounded-full p-0 ${theendStyles.button.primary} shadow-lg`}
                                                >
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    <div className="flex items-center justify-between">
                                                        <span className={`text-xs font-medium ${style.textClass}`}>{formatTime(currentTime)}</span>
                                                ...
                                                <Button
                                                    onClick={toggleMute}
                                                    variant="ghost"
                                                    className={`h-8 w-8 rounded-full p-0 hover:bg-white/10 ${style.textClass}`}
                                                >
                            ...
                            <motion.div className="mt-6 mb-8 flex items-center justify-between" variants={animation.item}>
                                    ...
                                    {isAuthenticated ? (
                                        <div className="group relative">
                                            <Button
                                                ...
                                                className={currentReaction ? reactionColors[currentReaction] : 'bg-gray-800 hover:bg-gray-700'}
                                            >
                                                {currentReaction ? (
                                                    <>
                                                        ...
                                                        <span className="ml-2 text-white">{theend.reactions.length}</span>
                                                    </>
                                                ) : (
                                                    <>
                                        ...
                                        <Button
                                            disabled
                                            className="cursor-not-allowed bg-gray-400 hover:bg-gray-400"
                                            title="Connectez-vous pour réagir"
                                        >
                                            <Heart className="mr-2 h-5 w-5" />
                                            <span className="text-white">Réagir</span>
                                            <span className="ml-2 text-white">{theend.reactions.length}</span>
                                ...
                                {isAuthenticated ? (
                                    <Button
                                        ...
                                        className={isSaved ? theendStyles.button.primary : theendStyles.button.secondary}
                                    >
                                        <Bookmark className={isSaved ? 'mr-2 fill-current' : 'mr-2'} />
                            ...
                            <p className={`text-lg leading-relaxed whitespace-pre-wrap ${style.textClass}`}>{theend.content}</p>
                        </CardContent>
                    </Card>
                </motion.div>
